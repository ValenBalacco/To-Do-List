...
export const ModalCrearTarea = ({ tarea, handleCloseModal, handleSaveTarea }: ModalCrearTareaProps) => {
  ...
  const handleSubmit = () => {
    if (!titulo.trim() || !descripcion.trim()) return; // Validación básica
  ...
  return (
    <div className={styles.overlay}>
      <div className={styles.modal}>
        ...
        />
        <div>
          <button onClick={handleSubmit}>{tarea ? "Guardar Cambios" : "Crear Tarea"}</button>
